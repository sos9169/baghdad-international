(() => {
  ...
  const translations = {
    ar: {
      ...
      "contact.cairoBranch": "🇪🇬 فرع أكاديمية بغداد الدولية (القاهرة — مصر)",
      "contact.cairoSub": "خدمات القبولات والدراسة بمصر",
      "contact.nileBranch": "🤝 شركة النيل للخدمات المتكاملة (مصر والسودان)",
      "contact.nileSub": "خدمات السودانيين والخدمات التجارية",
      ...
      "footer.brandName": "مجموعة بغداد الدولية",
      "footer.desc": "المظلة الاستثمارية والتنفيذية الرائدة في تقديم الخدمات التعليمية، القبولات الجامعية، والتجارة والاستشارات العامة في العراق، مصر، وتركيا.",
      "footer.col1Title": "روابط سريعة",
      "footer.col2Title": "مؤسساتنا وفروعنا",
      "footer.col3Title": "مقراتنا الرسمية",
      "footer.hq1Title": "المقر الرئيسي (العراق):",
      "footer.hq2Title": "فرع القاهرة (مصر):",
      "footer.hoursTitle": "أوقات العمل:",
      "footer.hours": "السبت – الخميس: 9:00 ص – 6:00 م"
    },
    en: {
      "brand.title": "Baghdad International",
      "brand.sub": "GROUP",
      "footer.brandName": "Baghdad International Group",
      "footer.desc": "The premier corporate umbrella offering education services, university admissions, and international trade in Iraq, Egypt, and Turkey.",
      "footer.col1Title": "Quick Links",
      "footer.col2Title": "Subsidiaries & Branches",
      "footer.col3Title": "Official Headquarters",
      "footer.hq1Title": "Primary HQ (Iraq):",
      "footer.hq2Title": "Cairo Branch (Egypt):",
      "footer.hoursTitle": "Working Hours:",
      "footer.hours": "Saturday – Thursday: 9:00 AM – 6:00 PM",
      "nav.home": "Home",
      "nav.about": "About Us",
      ...
      "contact.cairoBranch": "🇪🇬 Baghdad International Academy (Cairo — Egypt)",
      "contact.cairoSub": "Admissions & University Services in Egypt",
      "contact.nileBranch": "🤝 Al-Nile Integrated Services (Egypt & Sudan)",
      "contact.nileSub": "Sudanese & Business Services",
  ...
  const SUBSIDIARIES_DETAILS_MAP = {
    ...
    yalova: {
      ...
      badges: [
        { text_ar: "اسطنبول", text_en: "Istanbul", icon: "fa-solid fa-flag" },
    ...
    hadhara: {
      ...
      defaultService: "🎒 التعليم المدرسي (ابتدائي، إعدادي، ثانوي)",
      defaultCountry: "تركيا",
      desc_ar: "مدارس الحضارة العراقية في تركيا تقدم تعليماً لكافة المراحل الدراسية (ابتدائي، إعدادي، وثانوي) في اسطنبول، مع توفير بيئة تعليمية وتربوية حديثة وكادر تعليمي مؤهل ومدرسين ذوي كفاءة ممتازة.",
      desc_en: "Al-Hadhara Iraqi Schools in Turkey provides education for all school stages in Istanbul, featuring modern learning environments and qualified faculty.",
      badges: [
        { text_ar: "اسطنبول", text_en: "Istanbul", icon: "fa-solid fa-location-dot" },
