(() => {
  ...
  const translations = {
    ar: {
      ...
      "education.note": "ننسق خدمات الدراسة والتعليم المدرسي (ابتدائي، إعدادي، وثانوي)، والقبولات الجامعية، والتدريب المهني لأطباء الأسنان والمؤتمرات العلمية.",
      ...
      "program.2.text": "برامج تدريبية متخصصة ومتقدمة لتطوير المهارات العلمية والطبية لأطباء الأسنان.",
    ...
    en: {
      ...
      "education.note": "We coordinate study services, school education (Primary, Preparatory & Secondary), university admissions, and dental training courses.",
