(() => {
  ...
  const translations = {
    ar: {
      ...
      "about.text": "نساعدك في ترتيب الخطوات، فهم الإجراءات، واختيار الحل الأنسب لاحتياجك — بأسلوب واضح، سريع واحترافي، مع فريق دعم كامل بين بغداد ومصر وفريق محامين متخصص للحماية القانونية.",
      ...
      "education.note": "نرتب خطوات الدراسة، التقديمات الجامعية والتعليم المدرسي، التدريب المهني لأطباء الأسنان والمؤتمرات العلمية بطريقة واضحة.",
      "program.1.title": "الدراسة والقبولات الجامعية",
      "program.1.text": "تجهيز الملفات، متابعة التقديم والقبول الجامعي، والتسجيل المدرسي والجامعي.",
      "program.2.title": "دورات تدريبية لأطباء الأسنان",
      "program.2.text": "برامج تدريبية متخصصة ومتقدمة لتطوير المهارات العلمية والطبية.",
    ...
    en: {
      ...
      "about.text": "We help you organize the steps, understand the process and choose the right solution — clearly, quickly and professionally with dedicated support teams between Baghdad & Cairo.",
      "about.signature": "Baghdad International Group",
      "about.years": "+9",
      ...
      "education.note": "We organize study steps, university and school applications, dental training courses, and scientific conferences clearly.",
      "program.1.title": "Study & University Admissions",
      "program.1.text": "Preparing files, following applications, school and university admissions.",
      "program.2.title": "Dentistry Training Courses",
      "program.2.text": "Specialized and advanced training courses to develop clinical skills for dentists.",
